...
extra[NormalConfig.Group] = libs.cloud.plugin.get().group
extra[NormalConfig.Artifact] = libs.cloud.plugin.get().name
extra[NormalConfig.Version] = libs.cloud.plugin.get().version
