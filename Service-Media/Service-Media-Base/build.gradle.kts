...
extra[NormalConfig.Group] = libs.service.media.base.get().group
extra[NormalConfig.Artifact] = libs.service.media.base.get().name
extra[NormalConfig.Version] = libs.service.media.base.get().version
