...
public class ClassUtils {
    ...
    private static final Logger mLogger = Logger.create(ClassUtils.class.getName());
    ...
    public static Set<String> getFileNameByPackageName(Context context, final String packageName) throws Throwable {
        ...
        mLogger.debug("Filter " + classNames.size() + " classes by packageName <" + packageName + ">");
        return classNames;
    }
...
//        通过是否存在sp中的multidex.version是不准确的，因为从低版本升级上来的用户，是包含这个sp配置的
    ...
    private static List<String> tryLoadInstantRunDexFile(ApplicationInfo applicationInfo) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && null != applicationInfo.splitSourceDirs) {
            ...
            mLogger.debug("Found InstantRun support");
        } else {
            try {
                ...
                mLogger.debug("InstantRun support error, " + e.getMessage());
            }
        }
    ...
    private static boolean isVMMultidexCapable() {
        ...
        mLogger.debug("VM with name " + vmName + (isMultidexCapable ? " has multidex support" : " does not have multidex support"));
