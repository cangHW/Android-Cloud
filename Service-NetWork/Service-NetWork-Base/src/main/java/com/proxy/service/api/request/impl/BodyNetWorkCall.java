...
public final class BodyNetWorkCall<T> implements CloudNetWorkCall<T> {
    ...
    public CloudNetWorkResponse<T> execute() {
        ...
        String baseUrl = mRequest.httpUrl().baseUrl();
        if (!TextUtils.isEmpty(baseUrl)) {
            ...
            arrayList.addAll(NetWorkInterceptorCache.getInterceptors());
            ...
            response = CloudNetWorkResponse.error(new NullPointerException("baseUrl can not be null"));
        }
