...
public class CallbackManager {
    ...
    private static final ArrayList<CloudNetWorkGlobalCallback> CALLBACKS = new ArrayList<>(1);

    public static void setGlobalCallback(CloudNetWorkGlobalCallback callback) {
        if (callback == null) {
            return;
        }
        CALLBACKS.clear();
