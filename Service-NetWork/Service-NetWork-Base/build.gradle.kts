...
//extra[NormalConfig.Group] = libs.service.net.base.get().module.group
//extra[NormalConfig.Artifact] = libs.service.net.base.get().module.name
//extra[NormalConfig.Version] = libs.versions.service.net.base.version.get()
