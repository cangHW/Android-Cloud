...
extra[NormalConfig.Group] = libs.cloud.base.get().group
extra[NormalConfig.Artifact] = libs.cloud.base.get().name
extra[NormalConfig.Version] = libs.cloud.base.get().version
